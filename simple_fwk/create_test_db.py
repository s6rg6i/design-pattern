...
INSERT INTO courses VALUES (1,'Основы языка Python',''), (2,'Алгоритмы Python',''), (3,'Django',''), (4,'DRF',''),
(5,'Flask',''), (6,'Архитектура и шаблоны проектирования на Python',''), (7,'Асинхронный чат',''), (8,'HTML CSS',''),
(9,'Linux. Рабочая станция',''), (10,'Git. Базовый курс',''), (11,'MySQL',''), (12,'Компьютерные сети. Основы.','');
